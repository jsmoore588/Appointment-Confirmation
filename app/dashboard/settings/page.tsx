  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-3xl px-4 py-6 md:px-8 md:py-8">
      <section className="rounded-[2rem] border border-black/5 bg-white/80 p-6 shadow-card backdrop-blur md:p-8">
        ...
        <h1 className="mt-2 text-3xl font-semibold text-ink">OpenAI configuration</h1>
        <p className="mt-3 text-sm leading-7 text-black/60">
          Save your OpenAI API key here so the dashboard can generate smarter action summaries
          without putting the key in the browser extension.
        </p>
